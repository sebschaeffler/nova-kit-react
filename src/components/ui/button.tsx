    ...
    variants: {
      variant: {
        ...
        destructive:
          ...
          "disabled:border-destructive-disabled disabled:text-destructive-disabled focus-visible:ring-destructive/20 dark:bg-destructive/60 dark:focus-visible:ring-destructive/40",
        outline:
          "border border-[#9CA3AF] bg-background shadow-xs hover:bg-accent hover:text-accent-foreground dark:border-input dark:bg-input/30 dark:hover:bg-input/50",
        secondary:
