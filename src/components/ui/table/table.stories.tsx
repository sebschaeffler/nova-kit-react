...
import {
  ...
  TableHeader,
  TableRow,
} from "@nova/components/ui/table/table";
import TableExample from "@nova/components/ui/table/table-example";
import Image from "next/image";
import tasks from "./tasks/data/tasks.json";
import { columns } from "./tasks/components/columns";
import { DataTable } from "@nova/components/ui/table/tasks/components/data-table";
